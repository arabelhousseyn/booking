...
')
     ...
     */ 
         ...
         * 
         *
         * @see \App\Mixins\MigrationMixin::firebaseToken()
         * @static 
         */ 
        public static function firebaseToken()
        {
                        return \Illuminate\Database\Schema\Blueprint::firebaseToken();
        }
                    /**
         * 
         *
         * @see \App\Mixins\MigrationMixin::ribBankAccount()
         * @static 
         */ 
        public static function ribBankAccount()
        {
                        return \Illuminate\Database\Schema\Blueprint::ribBankAccount();
        }
                    /**
         * 
         *
         * @see \App\Mixins\MigrationMixin::dahabiaAccount()
         * @static 
         */ 
        public static function dahabiaAccount()
        {
                        return \Illuminate\Database\Schema\Blueprint::dahabiaAccount();
        }
